...
//!   In other words, it works a lot like the [`Display`](std::fmt::Display) trait, but instead of producing text intended
...
//! [`Display`](std::fmt::Display) trait to prevent accidentally leaking the type's data in a log or other mechanism.
//!
//! # Example
//!
//! ```rust
...
mod redact;
mod redactor;
mod nop_redactor_maker;
mod erasing_redactor_maker;
mod asterisk_redactor_maker;
mod redactor_maker;

#[cfg(feature = "xxh3")]
mod xxh3_redactor_maker;

pub use redact::Redact;
pub use redactor::Redactor;
pub use nop_redactor_maker::NopRedactorMaker;
pub use erasing_redactor_maker::ErasingRedactorMaker;
pub use asterisk_redactor_maker::AsteriskRedactorMaker;
pub use classified::Classified;
pub use sensitive::Sensitive;
pub use redactor_maker::RedactorMaker;

#[cfg(feature = "xxh3")]
pub use crate::xxh3_redactor_maker::xxH3RedactorMaker;
